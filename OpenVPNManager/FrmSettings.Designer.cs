...
namespace OpenVPNManager
{
    partial class FrmSettings
    {
        ...
        private void InitializeComponent()
        {
        	...
        	OpenVPNManager.Properties.Settings settings1 = new OpenVPNManager.Properties.Settings();
        	...
        	settings1.allowRemoteControl = false;
        	settings1.callUpdate = true;
        	settings1.debugLevel = 1;
        	settings1.firstStart = true;
        	settings1.lastUpdateCheck = new System.DateTime(((long)(0)));
        	settings1.searchUpdate = 0;
        	settings1.SettingsKey = "";
        	settings1.smartCardSupport = false;
        	settings1.startMinimized = true;
        	settings1.vpnbin = "";
        	settings1.vpnconf = "";
        	this.chkAllowCommandline.Checked = settings1.allowRemoteControl;
        	this.chkAllowCommandline.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "allowRemoteControl", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        	...
        	this.cbSmartCard.Checked = settings1.smartCardSupport;
        	this.cbSmartCard.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "smartCardSupport", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        	...
        	// txtOVPNConf
        	// 
        	this.txtOVPNConf.DataBindings.Add(new System.Windows.Forms.Binding("Text", settings1, "vpnconf", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        	resources.ApplyResources(this.txtOVPNConf, "txtOVPNConf");
        	this.txtOVPNConf.Name = "txtOVPNConf";
        	this.txtOVPNConf.ReadOnly = true;
        	this.txtOVPNConf.Text = settings1.vpnconf;
        	// 
        	// txtOVPNFile
        	// 
        	this.txtOVPNFile.DataBindings.Add(new System.Windows.Forms.Binding("Text", settings1, "vpnbin", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
        	resources.ApplyResources(this.txtOVPNFile, "txtOVPNFile");
        	this.txtOVPNFile.Name = "txtOVPNFile";
        	this.txtOVPNFile.ReadOnly = true;
        	this.txtOVPNFile.Text = settings1.vpnbin;
        	// 
        	// btnBrowseOVPNDir
        	// 
        	...
        	this.chkStartMinimized.Checked = settings1.startMinimized;
        	this.chkStartMinimized.CheckState = System.Windows.Forms.CheckState.Checked;
        	this.chkStartMinimized.DataBindings.Add(new System.Windows.Forms.Binding("Checked", settings1, "startMinimized", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged));
